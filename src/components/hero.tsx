...
export const HeroSection = ({ scrollToSection }: HeroProps) => {
    return (
        <section id="home" className="pt-16 min-h-screen bg-gradient-to-br from-red-50 via-white to-red-50 flex items-center">
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    <div className="space-y-8">
                        ...
                        <div className="grid grid-cols-3 gap-6 pt-8">
                            ...
                            <div className="text-center">
                                <div className="text-3xl font-bold text-red-600">5KM</div>
